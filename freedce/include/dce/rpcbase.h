...
#define rpc_c_protseq_max_reqs_default (0x0)
#define rpc_c_listen_max_calls_default (0xa)
...
#define rpc_c_binding_min_timeout (0x0)
#define rpc_c_binding_default_timeout (0x5)
#define rpc_c_binding_max_timeout (0x9)
#define rpc_c_binding_infinite_timeout (0xa)
typedef struct  {
uuid_t id;
unsigned32 version;
} rpc_syntax_id_t;
...
#define rpc_c_cancel_infinite_timeout (0xffffffff)
...
#define rpc_c_mgmt_inq_if_ids (0x0)
#define rpc_c_mgmt_inq_stats (0x1)
#define rpc_c_mgmt_is_server_listen (0x2)
#define rpc_c_mgmt_stop_server_listen (0x3)
#define rpc_c_mgmt_inq_princ_name (0x4)
typedef rpc_opaque_ptr_t rpc_ns_handle_t;
typedef rpc_ns_handle_t *rpc_ns_handle_p_t;
#define rpc_c_ns_none (0x0)
#define rpc_c_ns_dec_dns (0x1)
#define rpc_c_ns_ms_wins (0x2)
#define rpc_c_ns_ldap (0x3)
#define rpc_c_ns_syntax_default (0x0)
#define rpc_c_ns_syntax_unknown (0x1)
#define rpc_c_ns_syntax_dec_dns (0x2)
#define rpc_c_ns_syntax_dce (0x3)
#define rpc_c_ns_syntax_x500 (0x4)
#define rpc_c_ns_syntax_internet_dns (0x5)
#define rpc_c_ns_syntax_uuid (0x6)
#define rpc_c_ns_syntax_ms_wins (0x7)
#define rpc_c_ns_syntax_ldap (0x8)
#define rpc_c_profile_default_elt (0x1)
#define rpc_c_profile_all_elts (0x2)
#define rpc_c_profile_match_by_if (0x3)
#define rpc_c_profile_match_by_mbr (0x4)
#define rpc_c_profile_match_by_both (0x5)
#define rpc_c_binding_max_count_default (0x5)
...
#define rpc_c_protect_level_default (0x0)
#define rpc_c_protect_level_none (0x1)
#define rpc_c_protect_level_connect (0x2)
#define rpc_c_protect_level_call (0x3)
#define rpc_c_protect_level_pkt (0x4)
#define rpc_c_protect_level_pkt_integ (0x5)
#define rpc_c_protect_level_pkt_privacy (0x6)
#define rpc_c_authn_none (0x0)
#define rpc_c_authn_dce_secret (0x1)
#define rpc_c_authn_dce_public (0x2)
#define rpc_c_authn_dce_dummy (0x3)
#define rpc_c_authn_dssa_public (0x4)
#define rpc_c_authn_gss_negotiate (0x9)
#define rpc_c_authn_winnt (0xa)
#define rpc_c_authn_gss_tls (0xe)
#define rpc_c_authn_dpa (0x10)
#define rpc_c_authn_msn (0x11)
#define rpc_c_authn_gss_mskrb (0x12)
#define rpc_c_authn_netlogon (0x44)
#define rpc_c_authn_default (0xffffffff)
#define rpc_c_authz_none (0x0)
#define rpc_c_authz_name (0x1)
#define rpc_c_authz_dce (0x2)
#define rpc_c_authz_mspac (0x3)
typedef struct  {
unsigned32 magic;
idl_void_p_t data;
...
#define rpc_c_ep_max_annotation_size (0x40)
